...
-- Star Schema for retail_transactions.csv file
...
--- LOAD CLEANED DIMENSION DATA TABLES ---
...
--- LOAD CLEANED FACT DATA TABLE ---


INSERT INTO fact_sales (sales_key, transaction_id, date_key, store_key, product_key, units_sold, unit_price, total_sales) VALUES
(1, 'TXN5000', 20230829, 2, 6, 3, 49262.78, 147788.34),
(2, 'TXN5001', 20231212, 2, 7, 11, 23226.12, 255487.32),
(3, 'TXN5002', 20230205, 2, 4, 20, 48703.39, 974067.80),
(4, 'TXN5003', 20230220, 3, 7, 14, 23226.12, 325165.68),
(5, 'TXN5004', 20230115, 2, 5, 10, 58851.01, 588510.10),
(6, 'TXN5005', 20230809, 1, 1, 12, 52464.00, 629568.00),
(7, 'TXN5006', 20230331, 5, 5, 6, 58851.01, 353106.06),
(8, 'TXN5007', 20231026, 5, 3, 16, 2317.47, 37079.52),
(9, 'TXN5008', 20231208, 1, 2, 9, 27469.99, 247229.91),
(10, 'TXN5009', 20230815, 1, 5, 3, 58851.01, 176553.03);
